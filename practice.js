...
for (i=0; i < family.length; i++){ //why is var needed here?
  alert(family[i])
}
  console.log(family)
}
...
function reversedLooper (letters){
  for (i = letters.length -1; i >= 0; i--){ // i = letter.length (starting with the length of the array) i >= 0 (starting at the top of the array and working down) i-- (move down through index)
    alert(letters[i])
  }
    console.log(letters)
  }
...
evenFinder(nums) //** can't determine how to return only even numbers from this array */
